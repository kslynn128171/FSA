function msg=SingleSpectrumIdent_CASMI2016_massmatch_new(spectidx, elemnum, formula, mass, spectrum, opt)
% initial parameters
...
vec = str2double(strsplit(spectrum.ms2_peak,';'));
mz=vec(1:2:end); % m/z value
ab=vec(2:2:end); % abundance
